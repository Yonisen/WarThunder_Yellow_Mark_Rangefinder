...
def checkDistance(modelTank, modelMarker):
        ...
        screen = pyautogui.screenshot('Map.png', region=(3924,1684, 1196, 1196))

        #screen = Image.open('Map.png')
        #screen = cv2.imread('Map.png')[..., ::-1]
        #Map = Image.fromarray(screen)

        #cv2.imwrite("Map14.png", screen)                                   
        size = 388
        sizeK = 388/1196
        ...
        print("Tank position",tankPositionReal)
        ######################################################################
        ...
        print("Center of the yellow mark",markerPositionReal)
        ######################################################################
